...
//$prodcat=mysql_query("SELECT * FROM markers WHERE (city = '$ccity') OR (lat LIKE '$nnew_lat%%' AND lng LIKE '$nnew_long%%') ORDER BY city DESC, priority DESC LIMIT 5;");
$prodcat=mysql_query("SELECT * FROM markers WHERE (city = '$ccity') LIMIT 5;");
