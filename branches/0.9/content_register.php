...
<![endif]-->
  ...
  <tr>
    ...
    <td align="center" valign="bottom" bgcolor="#ffffff" class="invitado_home2" style="padding-bottom:1px; color:#000;"><div class="roudlite" style="padding:4px; padding-top:8px; padding-bottom: 8px;">busca restaurantes de cualquier ciudad<br />      <input name="busca" type="text" class="cajabox" id="busca" style="height:20px; padding:2px;"   onkeypress="javascript:busca(event);" onclick="this.className=(this.className=='cajaboxclick') ? 'cajabox':'cajaboxclick'" size="41" maxlength="42"/></div></td>
  </tr>
  </table>
