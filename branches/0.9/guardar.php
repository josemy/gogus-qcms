...
$query = sprintf("INSERT INTO markers " .
         " (`id`, `name`, `address`, `lat`, `lng`, `type`, `image`, `precio_medio`, `puntuacion`, `descripcion`, `desc_long`, `reserva_onl`, `tipo_cocina`, `web`, `tags`, `medio_user`) " .
...
print("<script>document.location.href='ver_local.php?id=".$iddd."'</script>");
?>
