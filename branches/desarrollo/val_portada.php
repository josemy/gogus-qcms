...
<table  border="0" cellpadding="4" cellspacing="4">
  <tr>
    <td width="50%"><a class="invitado_home2"><strong>Cerca de mi</strong></a></td>
    <td align="left"><img src="images/normal/001_08.png" style="cursor:pointer;" onclick="location.href='buscando.php?lo=<? echo($location["Longitude"]); ?>&la=<? echo($location["Latitude"]); ?>&city=<? echo($location["City"]); ?>'" height="24px" width="24px" title="Buscar cerca de mi" alt="Buscar cerca de mi" /></td>
  </tr>
  <tr>
