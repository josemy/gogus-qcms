...
<script type="text/javascript" src="bar/prototype.js"></script>
<script type="text/javascript" src="bar/jsProgressBarHandler.js"></script>
 -->
...
function CargaMapa(){
document.getElementById('loc').value=document.getElementById('newloc').value;
	llamarasincrono2('change_loc_map.php','cuerpo');
}

function filters_open(){
	if(document.getElementById('filtermap').style.height=='100px'){
		llamarasincrono2('blank.php','filteroptions');
	document.getElementById('filtermap').style.height='12px';
	}else{
document.getElementById('filtermap').style.height='100px';
llamarasincrono2('filter_options.php','filteroptions');
	}
}
</script>
...
<body onload="Muestra();loadmap();">
<div id="cargando" style="position:fixed; top:0px; left:0px; width:110px; height:25px; padding-top:2px;"><a class="textores2">&nbsp;<span class="textouserstopv3">Cargando...</span></a></span></div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" >
        <tr>
          <td colspan="2" align="center"><div align="center" style="position:relative; z-index:2;" class="roudlite2">
              <div id="filter_map" style="position:absolute; z-index:90; left:800px; visibility:hidden;">
    <? include("filter_map.php"); ?>
    </div>
              <? include("n2m/gmaps_n2m.php"); ?><div style="position:absolute; bottom: 0%; left:175px;" align="center">
