...
$citz = $_GET['citz'];
$coc = $_GET['coc'];
$vertipos=mysql_query("SELECT * FROM tipos_cocina WHERE id = '$coc';");
...
<table border="0" align="center" class="boxboxlighte" style=" background-color:#FFE">
  ...
  <tr>
    <td align="left"><input type="text" name="tipo_co" id="tipo_co" class="boxboxlighte" value="<? echo($coc); ?>"></td>
    ...
    <tr>
    <td><input type="text" name="phone" id="phone" class="boxboxlighte" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
