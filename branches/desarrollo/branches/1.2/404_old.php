...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td bgcolor="#CC3333" width="480" ><span style="border-bottom-width:4px; border-bottom-style:solid;border-bottom-color:#CCCCCC; padding-top:2px;"><img src="logo_test2.png" alt="logo" width="268" height="50" style="cursor:pointer;" onclick="document.location.href='<? echo($_URL_BASE); ?>'" /></span></span></td>
