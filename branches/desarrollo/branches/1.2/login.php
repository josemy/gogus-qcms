...
<table width="90%" border="0" class="boxboxlighte">
  <tr>
    <td><form id="submit" name="submit" method="post" action="userlogin.php?return=<? print($return_url); ?>"><table width="100%" border="0" cellpadding="2" cellspacing="2">
      <tr>
      ...
      <tr>
        ...
        <td valign="top"><div align="left">
          ...
          &nbsp;&nbsp;<input name="submit23" type="button" class="textbox" value="cerrar" onclick="javascript:TINY.box.hide()" /></div></td>
        </tr>
...
<table width="90%" border="0">
  <tr>
	...
	if($mensa=='f'){
		print_r("<a class='errortext'>Necesitas iniciar sesion para continuar...</a>");
