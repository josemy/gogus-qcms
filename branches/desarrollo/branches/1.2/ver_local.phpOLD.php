...
//Comprobar si el usuario ya ha votado
	...
	if($ver_sii=="0"){
			...
			mysql_query("INSERT INTO `comments` (`id` ,`local_id` ,`titulo` ,`comentario` ,`username` ,`timestamp` ,`voto`, `ip`)VALUES ('', '$id', '$titulo', '$comentario', '$username', '$timee', '$voto' , '$ip');");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="3" valign="top"><a class="textofootres4"><strong><? print($descri); ?></strong></a><br />
<a class="textofootres3"><? print($direcc." - </a><a class='textofootres2' href='http://".$web."'><u>".$web."</u>"); ?></a></td>
    <td valign="top"><? if ($username){
	?>
	...
	?></td>
    <td width="250" rowspan="2" align="center" valign="middle"><img src="resize_image.php?image=<? echo($img);?>&amp;new_width=200&amp;new_height=200"></td>
  </tr>
  <tr>
    <td colspan="4" valign="top"><p><a class="textofootres3"><strong><? print($long); ?></strong></a><br />
      <a class="textofootres3"><? print($vlong); ?></a>
      <br /></p></td>
  </tr>
  <tr>
  <td><? if($tipoco){ ?><a class="textofootres3">Cocina </a><a class="txtgra"> <? print($tipoco); ?></a><? } ?></td>
  <td><? if($precio){ ?><a class="textofootres3">Sobre </a><a class="txtgra"> <? print($precio); ?></a><a class="textofootres3"> Euros</a><? } ?></td>
  <? $pnt=round($pnt,2); ?>
    <td width="12%"><a class="textofootres3">puntuacion:</a><a class="txtgra"> <? print($pnt); ?></a>
    ...
    <td width="250" align="right"><?
		...
		print_r('<img src="images/normal/001_15.png" height="16" width="16">');
		if($count_f==1){
		print_r("<a class='nowp1'>Favorito de </a><a class='estilo2v3link'><strong>".$count_f."</strong></a><a class='nowp1'> usuario</a>");	
		}
		if($count_f>1){
		print_r("<a class='nowp1'>Favorito de </a><a class='estilo2v3link'><strong>".$count_f."</strong></a><a class='nowp1'> usuarios</a>");	
		}
					?></td>
  </tr>
  <tr>
    <td colspan="4"><p><div style="display:inline;"><img src="images/normal/001_35.png" height="16" width="16" title="Tags" alt="Tags" /><a class="textofootres3"><strong>Tags:  &nbsp;</strong></a><a class="textofootres2"><? foreach ($tags as $i) {
  print "<a href='buscando.php?p=".$i."' class='textofootres2'>".$i."</a><a class='textofootres2'>,</a>";
}
?>
</a>&nbsp;&nbsp;<? if ($username){ ?><a class="textofootres3"><strong>editar:</strong> </a>&nbsp;<img src="images/normal/001_45.png" height="16" width="16" title="Editar" alt="Editar" style="cursor:pointer;" onclick="document.location.href='pre_editar.php?id=<? echo($newid); ?>'" /><? } ?>
  ...
  if($num_com=="0"){
	  ?>
    <tr>
    <td colspan="4" class="boxboxlighte"><br /><a class="textofootres4"> Aun no existen comentarios para este local, se el primero votando positivo o negativo.</a><br /><br />
  ...
  <td>&nbsp;</td>
      ...
      <?
					...
					?>
  <tr>
    <td colspan="4" class="boxboxlighte"><img src="<? echo($voto_img); ?>" height="24" width="24" title="Positivo" alt="Positivo" /><a class="textofootres4"><? print($com_tit); ?></a><br /><a class="textofootres3"><? print($com_text); ?></a><br /><a class="textofootres2">De <? print($com_user); ?> el <? print($com_time); ?></a><br />
