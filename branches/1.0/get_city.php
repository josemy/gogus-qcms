...
echo "Your Proxy IPaddress is : ".$pipaddress. "(via $ipaddress)" ;
    ...
    function ver_cit($lt, $ln) {
					$formats_allowed = array("json", "xml", "raw");
					$query_url = "http://ws.geonames.org/findNearbyPlaceName?lat=";
		...
		$locationInfo = parseLocationData2($xmlData);
