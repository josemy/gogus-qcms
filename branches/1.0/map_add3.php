...
function showAddress(response) {
  ...
  if (!response || response.Status.code != 200) {
	...
	var html = "<table>" +
						 ...
						 "<tr><td><a class='estilo2v3black'>Localidad:</a></td> <td><input class='boxboxlighte' type='text' id='citz' value='" +place.AddressDetails.Country.AdministrativeArea.SubAdministrativeArea.Locality.LocalityName+"'/></td> </tr>" +
    ...
    function saveData() {
	  ...
	  llamarasincrono2("pre_guardar.php?name=" + name + "&address=" + address + 
                "&type=" + type + "&lat=" + lat + "&lng=" + lng + "&citz=" + citz,'contenido2');
    }
    </script>
