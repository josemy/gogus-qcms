...
<div id="apDiv1" style="position: absolute; left:80%; top:8px; width:24px; height:24px; z-index:1;"><img src="images/normal/001_08.png" style="cursor:pointer;" onclick="location.href='buscando.php?lo=<? echo($location["Longitude"]); ?>&la=<? echo($location["Latitude"]); ?>&city=<? echo($location["City"]); ?>'" height="24px" width="24px" title="Buscar cerca de mi" alt="Buscar cerca de mi" /></div>
<table width="87%"  border="0" cellpadding="4" cellspacing="4" class="roudlite_g_b" style=" left:2px;" >
  <tr>
  ...
  <tr>
	...
	if($city){
$ver_todo=mysql_query("SELECT * FROM markers WHERE city = '$city' LIMIT 3 ;");
...
');
				...
				while ($prodrow=mysql_fetch_array($ver_todo)){
					...
					print_r("<p><a class='textofootres4' href='sitio/".$titulo_f."'><u><b>".$descri."</b></u></a><a class='textofootres3'> en ".$direcc."</a>".$distancia."</p>");
