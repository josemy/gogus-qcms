...
?>
	 ...
	 ?><br />
<div class="boxboxlightw" style=" padding:2px;width:250px;float:right"><a class="nowp1"><? print($comment);?></a></div> <? }else{ ?><div class="boxboxlightw" style=" padding:2px;width:250px;float:right"><a class="textofootres2" id="comentar<? echo($rid);?>"  style="cursor:pointer;">insertar comentario</a></div><? } ?> </td>
        <td></td>
      </tr>
<? } ?>      
    </table>
