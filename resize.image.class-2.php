...
/*
---------------------------------------------------------------------
Descripcion: Clase para cambiar el tamaño a images.
Autor: Ruben Garcia - GOGUS CB - 2009 - www.gogus.es
Licencia: GPLv3 - 2009
---------------------------------------------------------------------
*/
class Resize_Image {
...
if($this->ratio)
{
		...
		if((float)$width > (float)$height){
			...
			$new_ratio=$width/$this->new_width;
			
			$this->new_height=$height/$new_ratio;
		
			
	
			
		}else{
			$new_ratiho=$height/$this->new_height;
			
			$this->new_width=$width/$new_ratiho;
