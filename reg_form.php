...
<?			
			if ($regerr=="TOO_SHORT"){
			$mensa="<a class='errortext'>El usuario ha de tener mas de 3 caracteres </a>";
			}
			if ($regerr=="ALREADY_REG"){
			$mensa="<a class='errortext'>El usuario introducido esta bloqueado, elige otro.</a>";
			}
			if ($regerr=="INVALID_MAIL"){
			$mensa="<a class='errortext'>El Mail introducido es incorrecto.</a>";
			}
			if ($regerr=="EMAIL_ALREADY_REG"){
			$mensa="<a class='errortext'>Ya existe otro usuario con esa direccion de email.</a>";
			}
			if ($regerr=="USERNAME_ALREADY_REG"){
			$mensa="<a class='errortext'>El usuario ya esta registrado.</a>";
			}
			if ($regerr=="PASS_ERROR"){
			$mensa="<a class='errortext'>Las claves introducidas no coinciden.</a>";
			}			
			if ($regerr=="UNHANDLED_ERROR"){
			$mensa="<a class='errortext'>Error inesperado, por favor, vuelve a intentarlo.</a>";
			}
			if($mensa==''){
			$mensa='tus datos solo seran usados para detectar que sitios te interesan mas';			
			}
?>
 <div align="center">
    ...
    <tr>
      <td><div align="center">          <a class="textonormalgran">1.  rellena todos los campos siguientes: </a><br /><br />
          <table width="90%" height="25" border="0" class="boxwarn">
            <tr>
              <td valign="middle"> <div align="center"><img src="images/alert1.gif" width="16" height="16" />&nbsp;&nbsp;<a class="estilo2v3black"> <? print($mensa);?></a> </div></td>
            </tr>
          </table>
          <br />
          <table width="90%"  border="0" cellpadding="0" cellspacing="5">
            <tr>
              ...
              <td width="455">
                <div align="left">
                  <input name="username" type="text" class="textbox" id="username" onChange="javascript:buscaUser();" value="<? echo($_SESSION['_username']); ?>" size="26">
            ...
            <tr>
              ...
              <td>
                  <div align="left">
                    <input name="name" type="text" class="textbox" value="<? echo($_SESSION['_name']); ?>" size="26">
                  </div></td>
            </tr>


            <tr>
              <td style="padding-top:4px;" valign="top"><div align="right"><a class="estilo2v3">Ciudad:</a></div></td>
              <td>&nbsp;</td>
              <td style="padding-top:4px;"><div align="left">
                <input name="cp" type="text" class="textbox" id="cp" value="<? echo($_SESSION['cp']); ?>" size="26">
              <br />
<a class="michat">(importante para ofrecerte sitios cercanos)</a></div></td>
            </tr>
            ...
            <tr>
              ...
              <td>
                  <div align="left">
                    <input name="email" type="text" class="textbox" value="<? echo($_SESSION['maili']); ?>" size="26">
                  </div></td>
            </tr>
          </table>
...
&nbsp;&nbsp;&nbsp;&nbsp; </font></font></font> </font> </font> </font></div></td>
    ...
    id="change-image">&iquest;texto ilegible? Cambiar</a>&nbsp;</td>
          ...
          <tr>
            ...
            <td class="textonormalmedio"><div align="center">
              <input name="submit2" type=button class="textbox" value="cerrar" onClick="javascript:TINY.box.hide()">
            </div></td>
            <td>&nbsp;</td>
          </tr>
        </table>
