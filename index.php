...
<body onload="Muestra()">
<div id="cargando" style="position:fixed; top:0px; left:0px; width:110px; height:25px" class="boxboxlighte"><a class="textores2">Cargando...</a></div>
...
<td></td>
  ...
  <tr>
    ...
    <td align="center" bgcolor="#FFFFFF"><div id="principal" style=" position:relative;height:550px; width:960px;border-bottom-width:1px; border-bottom-style:solid;border-bottom-color:#E3ECF3;border-left-style:solid;border-left-width:1px; border-left-color:#E3ECF3;border-right-style:solid;border-right-width:1px; border-right-color:#E3ECF3; " align="center">
